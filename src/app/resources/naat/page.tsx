...
export default function NaatShareef() {
  // Pagination State
  ...
  // Full Naat Collection with YOUR 12 LINKS
  const allNaat = generateNaatCollection()
  
  // Calculate pagination
  const totalPages = Math.ceil(allNaat.length / itemsPerPage)
  const startIndex = (currentPage - 1) * itemsPerPage
  const endIndex = startIndex + itemsPerPage
  const currentNaat = allNaat.slice(startIndex, endIndex)
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 px-6 md:px-8 py-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    <div className="relative p-2.5 rounded-xl bg-gradient-to-br from-[#D4AF37]/30 to-[#D4AF37]/10 border border-[#D4AF37]/30">
                      <FaMicrophone className="text-[#D4AF37] text-xl" />
                    </div>
                  </div>
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
                      <span className="text-white">Naat</span>
                      <span className="text-[#D4AF37]"> Shareef</span>
                    </h1>
                    <p className="text-gray-400 text-xs hidden sm:block">
                      Beautiful Naat collections with Arabic text and translations
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/20">
                  <FaHeadphones className="text-[#D4AF37] text-xs" />
                  <span className="text-gray-300 text-xs font-medium">{allNaat.length} Naats</span>
                </div>
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-[#1a3d2a]/90 via-[#1a4d2e]/80 to-[#112c1b]/90 backdrop-blur-2xl border border-[#D4AF37]/20 hover:border-[#D4AF37]/40 rounded-xl p-4 transition-all duration-500 shadow-lg hover:shadow-2xl hover:shadow-[#D4AF37]/10 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  {naat.externalLink && (
                    <button 
                      onClick={() => window.open(naat.externalLink, '_blank')}
          ...
          <div className="mt-10 flex flex-col items-center gap-3">
            <p className="text-gray-500 text-xs">
              ...
              <span className="text-[#D4AF37] font-semibold">
                {Math.min(endIndex, allNaat.length)}
              </span>{' '}
              of <span className="text-[#D4AF37] font-semibold">{allNaat.length}</span> Naats
            </p>
...
// ============================================
// YOUR 12 NAAT LINKS - ADD NEW LINKS HERE
// ============================================
function generateNaatCollection() {
  const naatData = [
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=u53orMnVf9Q'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=KaJUCXdIMi4'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=GMHX3QCNUow'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=AnPxiClcPO0'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=5SnQlZdm358'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=KM9eAcKZlEk'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=jWPGJDwfh9Q'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=Hurzesb8dhI'
    },
    {
      title: 'ALLAH Ke Naam',
      reciter: 'Qari Shahid Mehmood',
      ...
      externalLink: 'https://www.youtube.com/watch?v=Cr2Jr1jkuOM'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=kn03lDXiAAk'
    },
    {
      ...
      externalLink: 'https://www.youtube.com/watch?v=0Fal15jO3Ko'
    },
    {
       title: 'Kalaam Hazrat Sultan Bahoo',
      reciter: 'Prof Abdul Rauf Rufi',
      description: 'Beautiful Kalaam of Hazrat Sultan Bahoo (RA) by Prof Abdul Rauf Rufi',
      youtubeId: '56-7Hs-o-co',
      externalLink: 'https://www.youtube.com/watch?v=56-7Hs-o-co'
    }
  ]
