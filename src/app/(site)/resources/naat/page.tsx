...
export default function NaatShareef() {
  const [allNaat, setAllNaat] = useState<PlayableItem[]>([])
  ...
  useEffect(() => {
    fetch('/api/content/naat')
      .then((res) => res.json())
      .then((data) => {
        const items: PlayableItem[] = (data.items || []).map((n: any) => ({
          id: n.id,
          title: n.title,
          subtitle: n.reciter,
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-950 via-green-850 to-green-950 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
                      ...
                      <span className="text-gold-500"> Shareef</span>
                    </h1>
        ...
        <YoutubeStyleTheater
          items={allNaat}
          loading={loading}
          emptyMessage="No naat have been added yet. Check back soon!"
          kindLabel="Naat"
          subtitleFieldLabel="Reciter"
          accentIcon={<FaMicrophone className="inline text-gold-500 text-xs" />}
        />
