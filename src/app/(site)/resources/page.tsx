...
const resources = [
  ...
  },
  {
    icon: <FaMicrophone />,
    title: 'Naat Shareef',
    description: 'Listen to heartfelt Naat performances praising the Prophet ﷺ.',
    link: '/resources/naat'
  },
  {
    icon: <FaHeadphones />,
  ...
  },
  {
    icon: <FaVideo />,
    title: 'Bayan',
    description: 'Watch inspiring Islamic bayan and lectures from respected scholars.',
  ...
  },
  {
    icon: <FaImages />,
    title: 'Gallery',
    description: 'Browse pictures from our community, events, and masajid.',
    link: '/gallery'
  },
  {
    icon: <FaBlog />,
