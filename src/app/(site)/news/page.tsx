    ...
    fetch('/api/content/news')
      ...
      .then((data) => {
        const items = (data.items || []).map((n: any) => ({
          ...n,
          date: new Date(n.publishedAt || n.createdAt).toLocaleDateString('en-US', {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 px-6 md:px-8 py-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    <div className="relative p-2.5 rounded-xl bg-gradient-to-br from-gold-500/30 to-gold-500/10 border border-gold-500/30">
                      <FaNewspaper className="text-gold-500 text-xl" />
                    </div>
                  </div>
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
                      <span className="text-white">News</span>
                      <span className="text-gold-500"> Updates</span>
                    </h1>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gold-500/10 border border-gold-500/20">
                  <FaFire className="text-gold-500 text-xs" />
        ...
        {featuredNews && (
          <div className="mb-8 group">
            <div className="relative bg-gradient-to-r from-green-825/90 via-green-900/80 to-green-850/90 backdrop-blur-2xl border border-gold-500/20 hover:border-gold-500/40 rounded-2xl p-6 transition-all duration-500 shadow-lg hover:shadow-2xl hover:shadow-gold-500/10 overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-start gap-6">
                ...
                <div className="flex-shrink-0">
                  <button className="bg-gold-500 hover:bg-gold-600 text-green-950 font-semibold text-sm px-6 py-2.5 rounded-lg transition-colors flex items-center gap-2 shadow-lg shadow-gold-500/20 hover:shadow-gold-500/40">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-20 text-gray-500 text-sm">
            <FaSpinner className="animate-spin mr-2" /> Loading news...
          </div>
        ) : (
        <div 
          ref={gridRef}
        ...
        >
          {currentNews.length === 0 ? (
            <div className="col-span-full bg-green-850/80 border border-gold-500/20 rounded-xl p-12 text-center">
              ...
              <p className="text-gray-400">{allNews.length === 0 ? 'No news articles have been published yet. Check back soon!' : 'No news found matching your search.'}</p>
            </div>
          ) : (
            restNews.map((news, index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-green-825/90 via-green-900/80 to-green-850/90 backdrop-blur-2xl border border-gold-500/20 hover:border-gold-500/40 rounded-xl p-5 transition-all duration-500 shadow-lg hover:shadow-2xl hover:shadow-gold-500/10 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-3">
                      <div className="w-12 h-12 rounded-xl bg-gold-500/10 flex items-center justify-center border border-gold-500/20 group-hover:border-gold-500/40 transition-all">
                        <FaNewspaper className="text-gold-500 text-xl group-hover:scale-110 transition-transform" />
                      </div>
                    </div>
        ...
        {totalPages > 1 && (
          <div className="mt-10 flex flex-col items-center gap-3">
            <p className="text-gray-500 text-xs">
              ...
              of <span className="text-gold-500 font-semibold">{filteredNews.length}</span> News
            </p>
        ...
        <div className="mt-4 text-center">
          <p className="text-[10px] text-gray-600 tracking-wider">
            <FaNewspaper className="inline mr-1.5 text-gold-500/30 text-[10px]" />
