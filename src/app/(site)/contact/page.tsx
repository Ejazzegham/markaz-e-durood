      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 px-6 md:px-8 py-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
                      ...
                      <span className="text-gold-500"> Us</span>
                    </h1>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gold-500/10 border border-gold-500/20">
                  <FaClock className="text-gold-500 text-xs" />
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Location Card */}
            <div className="bg-green-850/80 border border-gold-500/20 rounded-xl p-6 hover:border-gold-500/40 transition-all hover:-translate-y-1">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-xl bg-gold-500/10 border border-gold-500/20">
                  <FaMosque className="text-gold-500 text-xl" />
                </div>
                <div>
            ...
            <div className="bg-green-850/80 border border-gold-500/20 rounded-xl p-6 hover:border-gold-500/40 transition-all hover:-translate-y-1">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:markaz.e.durood@gmail.com" className="text-gold-500 text-sm hover:underline">
            ...
            <div className="bg-green-850/80 border border-gold-500/20 rounded-xl p-6 hover:border-gold-500/40 transition-all hover:-translate-y-1">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-xl bg-gold-500/10 border border-gold-500/20">
                  <FaPhone className="text-gold-500 text-xl" />
                </div>
                <div>
                  <h3 className="text-white font-semibold mb-1">Phone & Web</h3>
                  <p className="text-gray-300 text-sm">
                    Tel: <a href="tel:+923008162244" className="text-gold-500 hover:underline">0300-8162244</a>
                  </p>
                  <p className="text-gray-300 text-sm">
            ...
            {/* Opening Hours */}
            <div className="bg-green-850/80 border border-gold-500/20 rounded-xl p-6 hover:border-gold-500/40 transition-all">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-xl bg-gold-500/10 border border-gold-500/20">
          ...
          <div className="lg:col-span-3">
            <div className="bg-green-850/80 border border-gold-500/20 rounded-xl p-6 md:p-8 hover:border-gold-500/40 transition-all">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 rounded-lg bg-gold-500/10 border border-gold-500/20">
                  <FaPaperPlane className="text-gold-500 text-sm" />
                </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-gray-300 text-sm block mb-1.5 flex items-center gap-2">
                        <FaUser className="text-gold-500 text-xs" /> Your Name
                      </label>
                      <input
                        type="text"
                        value={formData.name}
                    ...
                    <div>
                      <label className="text-gray-300 text-sm block mb-1.5 flex items-center gap-2">
                        <FaEnvelope className="text-gold-500 text-xs" /> Email
                      </label>
                      <input
                        type="email"
                  ...
                  <div>
                    <label className="text-gray-300 text-sm block mb-1.5 flex items-center gap-2">
                      <FaComment className="text-gold-500 text-xs" /> Subject
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-gray-300 text-sm block mb-1.5 flex items-center gap-2">
                      <FaComment className="text-gold-500 text-xs" /> Message
                    </label>
                    <textarea
                      rows={5}
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gold-500 hover:bg-gold-600 text-green-950 font-bold py-3 rounded-lg transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
        ...
        <div className="mt-4 text-center">
          <p className="text-[10px] text-gray-600 tracking-wider">
            <FaMosque className="inline mr-1.5 text-gold-500/30 text-[10px]" />
